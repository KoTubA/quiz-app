...
const QuestionDisplay = ({ question, currentIndex, totalQuestions }) => {
  ...
  return (
    <div>
      <div className="relative bg-surface-dark rounded-xl px-4 sm:px-6 py-4 border border-slate-700 shadow-xl overflow-hidden group mb-6">
        ...
        <h2 className="text-lg sm:text-xl leading-8 font-bold text-slate-100 whitespace-pre-line">{question.question}</h2>
      </div>
      {question.image && (
        <div className="mb-6">
